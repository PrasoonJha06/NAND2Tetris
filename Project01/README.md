...
Next, multi-bit versions (16 bit to be precise) of the aforementioned chips are constructed. These are pretty straightforward. 16 1-bit chips work independently on every bit to give us the result.
